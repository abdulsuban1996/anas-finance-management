// ANAS FINANCE TRACKER - PERMANENT SINGLE-USER AUTHENTICATION (LOGIN ONCE)
...
export const AuthAdapter = {
  ...
  isAuthenticated: () => {
    ...
    // Logged in once and saved permanently in localStorage
    return (
      localStorage.getItem(AUTH_KEY) === 'authenticated' ||
      localStorage.getItem(PWA_AUTH_KEY) === 'authenticated'
    );
  },
