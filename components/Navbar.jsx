        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              className="lg:hidden p-2 rounded-xl bg-white/10 hover:bg-white/15 text-white border border-white/15 transition-all"
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden fixed inset-0 z-50 flex">
            ...
            <motion.div
              ...
              className="relative z-10 w-72 h-full shadow-2xl overflow-hidden border-r border-white/10"
            >
